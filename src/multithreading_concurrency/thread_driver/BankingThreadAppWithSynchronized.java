...
class SBIBanking {
    ...
    public static void withdraw(int amount){
        ...
        synchronized(SBIBanking.class){ 
            System.out.println("Static block to see how class Level Lock works for Synchronization" + Thread.currentThread().getName());
        }
    }
    int balance = 4000;
...
class WithdrawTask implements Runnable {
    ...
    public void run() {
        ...
        // bank.withdraw(1000); // To see class Level lock and synchronization for static method blocks
    }
}
